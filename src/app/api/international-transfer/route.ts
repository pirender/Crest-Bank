import { loan, transactions, users, wire } from "@/lib/airtable";
...
export async function POST(request: Request) {
    ...
    const { bank_name, payment_account, amount, account_type, account_number, account_name, country, routing_number, details } = await request.json();
    try {
